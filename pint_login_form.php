...
if ($inscHabilitada){
	...
	print <<<x001
		...
		El proceso finaliz&oacute; el Viernes 08/08/2014 a la 1:00 pm.<br>
		</div><br>
x001;
    ...
    <tr>
		<td class ="instruc" style="padding-left:10px;padding-top:10px;" width="50%">
			...
			<ul style="padding-right:25px;text-align:justify;font-size:8pt;">
				<li>El valor de cada asignatura es de <strong><?php echo $valorMateria;?> Bs.</strong> (<?php echo $valorPreMateria." Bs. Pre Inscripcion + ";echo $valorMateria-$valorPreMateria." Bs. Inscripcion";?>)</li>
